...
import { alertType, toasterData } from "../../services/alert/alert-context";
  ...
  switch (type) {
    case alertType.success:
      return (
        <div
          key={id}
          className="flex w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-md m-2"
        >
...
const AlertComponent: FunctionComponent<alertComponentProps> = ({ toasts }) => {
  console.log(toasts);
  return (
